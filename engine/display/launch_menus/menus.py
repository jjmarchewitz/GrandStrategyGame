...
class MainMenu(Menu):
    ...
    def main_menu_buttons(self):
        ...
        self.add_button(
            ...
            Button(
                "SINGLE PLAYER",
                lambda: self.event_handler.create_and_push_state_event(
                    self.state_manager.launch_menu["SP"]
                ),
        ...
        self.add_button(
            ...
            Button(
                "HOST",
                lambda: self.event_handler.create_and_push_state_event(
                    self.state_manager.launch_menu["HOST"]
                ),
        ...
        self.add_button(
            ...
            Button(
                "JOIN",
                lambda: self.event_handler.create_and_push_state_event(
                    self.state_manager.launch_menu["JOIN"]
                ),
        ...
        self.add_button(
            ...
            Button(
                "OPTIONS",
                lambda: self.event_handler.create_and_push_state_event(
                    self.state_manager.launch_menu["OPTIONS"]
                ),
    ...
    def button_coords_from_order(self, order_num):
        ...
        spacing_y = self.window.properties.height_unit + int(
            0.75 * self.window.properties.height_unit
        )
    ...
    def draw_title(self):
        ...
        title_surface = pg.Surface(
            (self.window.properties.width, number_of_lines * line_height)
        )
        ...
        for line_number, line in enumerate(wrapped_title_text_lines):
            ...
            top_left_x = int(
                self.window.properties.width / 2 - text_surface.get_width() / 2
            )
        ...
        top_left_y = int(
            self.properties.title_center_y - title_surface.get_height() / 2
        )
    ...
    def single_player_menu_buttons(self):
        ...
        self.add_button(
            ...
            Button(
                "NEW GAME",
                lambda: self.event_handler.create_and_push_state_event(
                    self.state_manager.in_game["NEW_GAME"]
                ),
                (
                    (
                        self.window.properties.center_x,
                        self.window.properties.center_y
                        - 2 * self.window.properties.height_unit,
                    )
                ),
            ),
        )
        self.add_button(
            ...
            Button(
                ...
                lambda: self.event_handler.create_and_push_state_event(
                    self.state_manager.launch_menu["LOAD_SAVE"]
                ),
        ...
        self.add_button(
            ...
            Button(
                "BACK TO MAIN",
                lambda: self.event_handler.create_and_push_state_event(
                    self.state_manager.launch_menu["MAIN_MENU"]
                ),
                (
                    self.window.properties.center_x,
                    self.window.properties.center_y
