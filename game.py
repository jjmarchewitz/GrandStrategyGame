...
class GameExecutor:
    ...
    def __init__(self):
        ...
        self.event_handler.create_and_push_state_event(
    ...
    def main(self):
        ...
        while True:
            ...
            event_processing_function_list = (
                self.get_current_event_processing_function_list()
            )
    ...
    def get_current_event_processing_function_list(self):
        ...
        if (
            self.state_manager.super_state
            == self.state_manager.super_states["LAUNCH_MENU"]
        ):
            event_processing_functions_list = [
                self.launch_menu.run,
            ]
        elif (
            self.state_manager.super_state == self.state_manager.super_states["IN_GAME"]
        ):
            event_processing_functions_list = [
                self.server.run,
                self.client.run,
